...
𝙷𝙴𝚁𝙴 𝙸𝚂 𝙼𝚈 𝙷𝙴𝙻𝙿 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂."""
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/akhil_tg>ᴀᴋʜɪʟ ᴛɢ</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: KOYEB
✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v2.0.1 [ monster ]"""
    SOURCE_TXT = """<b>🇷‌🇴‌🇱‌🇪‌🇽‌ 🇮‌🇸‌ 🇦‌🇳‌ 🇴‌🇵‌🇪‌🇳‌ 🇸‌🇴‌🇺‌🇷‌🇨‌🇪‌ 🇵‌🇷‌🇴‌🇯‌🇪‌🇨‌🇹‌</b>
You can easily get its source code from github - <a href='https://t.me/moviehub_plus'>🇷‌🇴‌🇱‌🇪‌🇽‌</a>"""
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/moviehub_plus)</code>
<b>Alert buttons:</b>
